...
Before setting up my React Native Project with Expo and Metro Server, I was initially installing the necessary dependencies for React Native development. I first tested if the necessary dependencies for React Native were available by initally making a React Native project wihtout Expo and Metro server first. During the testing, I noticed that it was not detecting my Android SDK in my desktop and initally thought that it was needed for setting up the React Native project with Expo and Metro server. It took me a while to figure out that I didn't need Android Studio or Android SDK to properly set up the React Native project with Expo and Metro Server. Aside from that, the process of setting up the project was smooth and seamless and I was amazed at how I could easily see the changes from my phone immediately without needing a cable or a virtual emulator.
